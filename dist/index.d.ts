import { Extension, MappablePosition, GetUpdatedPositionResult, Editor } from '@tiptap/core';
 ...
 */
declare function getUndoDepth(editor: Editor): number;
/**
 * Get the current redo stack depth
 * @param editor - The Tiptap editor instance
 * @returns The number of items in the redo stack
 */
declare function getRedoDepth(editor: Editor): number;

export { Collaboration, CollaborationMappablePosition, type CollaborationOptions, type CollaborationStorage, createMappablePosition, Collaboration as default, getRedoDepth, getUndoDepth, getUpdatedPosition, isChangeOrigin };
