  ...
  onCreate() {
    if (
      this.editor.extensionManager.extensions.find(
        (extension) =>
          extension.name === "history" || extension.name === "undoRedo"
      )
    ) {
      console.warn(
        '[tiptap warn]: "@tiptap/extension-collaboration" comes with its own history support and is not compatible with "@tiptap/extension-history" or "@tiptap/extension-undo-redo".'
      );
    }
  },
  addCommands() {
    ...
    yUndoPluginInstance.spec.view = (view) => {
      ...
      return {
        destroy: () => {
          ...
          if (
            viewRet === null || viewRet === void 0 ? void 0 : viewRet.destroy
          ) {
            viewRet.destroy();
          }
        },
